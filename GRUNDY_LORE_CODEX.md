...
2. [The Eight Known Varieties](#the-eight-known-varieties)
   ...
   - [Grib — The Mischievous One](#-grib)
   - [Plompo — The Sleepy One](#-plompo)
   - [Fizz — The Electric One](#-fizz)
   - [Ember — The Proud One](#-ember)
   - [Chomper — The Hungry One](#-chomper)
   - [Whisp — The Mysterious One](#-whisp)
   - [Luxe — The Fancy One](#-luxe)
...
## The Eight Known Varieties

*Taxonomic classifications are futile. They resist categorization. But patterns emerge.*
...
### Fragment II — Formation
*Academic notation, author disputed:*

> Munchlets crystallize from **sustained comfort** — not a single moment, but accumulated warmth. They are more common in homes with:
> - Regular meals eaten together
> - Sunlight through south-facing windows  
> - The smell of baking
>
> They appear to *wait* before revealing themselves. Patience is fundamental to their nature.

### Fragment III — Observed Behaviors
...
### Fragment II — Formation
*From "A Study of Chaos-Adjacent Entities," Chapter 7:*

> Unlike comfort-spirits, Gribs emerge from **disorder with joy** — specifically, the moment when something goes wrong and everyone laughs anyway.
>
> A dropped cake at a birthday party. A spectacular failed prank. The crash that precedes relief.
>
...
### Fragment II — Formation
*Excerpt from "On Dreams and Their Residue":*

> Plompos condense from **perfect rest** — the weighted warmth before sleep, the reluctance to wake, the sacred laziness of a day with no demands.
>
> They are, in essence, naps given form.
>
...
### Fragment II — Formation
*From "Electrical Anomalies and Emotional Resonance":*
...
>
> They are literally made of excitement.
>
> This explains their inability to remain still. Stillness is antithetical to their composition.
...
### Fragment II — Formation
*"On Spirits of Defiance," academic treatise:*

> Embers do not form from fire itself — fire is common and dies easily.
>
> Embers form from **the refusal to die**. The last coal. The spark that should have failed but didn't. The stubborn insistence on existing when extinction was certain.
>
...
### Fragment II — Formation
*From "Simple Spirits: A Study in Elemental Desires":*
...
>
> Researchers initially theorized complex motivations.
>
> Further study confirmed: it really is just about food.
...
### Fragment II — Formation
*"The Permeable Boundary: Spirits of the Threshold":*
...
>
> They are partially *here* and partially *elsewhere*.
>
> Where "elsewhere" is remains unknown. Whisps do not explain. It is unclear if they can.
...
### Fragment II — Formation
*From "Spirits of Uncertain Origin" (incomplete manuscript):*
...
>
> Alternatively: Luxe may have invented this explanation.
>
> We cannot verify. Luxe declines to cooperate with research it deems "tedious."
...
## Shared Lore & World Rules

### How Grundies Choose Their Person
...
### Can You Have Multiple Grundies?
...
>
> I asked a Munchlet once. Directly. "Why me?"
>
> It just hummed.
>
...
## In-Game Lore Journal System

### Overview

Players unlock lore fragments through gameplay, building their own copy of the Grundy Codex. This creates collectible content with emotional depth.
...
│ Fragment II — Formation         │
│ ─────────────────────────────── │
│ Academic notation, author       │
│ disputed:                       │
│                                 │
│ "Munchlets crystallize from     │
│ sustained comfort — not a       │
│ single moment, but accumulated  │
│ warmth..."                      │
│                                 │
│ 📖 Tap to read full fragment    │
└─────────────────────────────────┘
```

### Secret Fragment Presentation

Secret fragments appear different — handwritten style, slightly damaged appearance:
...
│ ═══════════════════════════════ │
│                                 │
│   "Munchlet remembers being     │
│    alone before you found       │
│    them. They don't talk        │
│    about it, but it's why       │
│    they light up so bright      │
│    when you come back."         │
│                                 │
│ ♡ Unlocked at Bond Level 50     │
└─────────────────────────────────┘
```
...
### Per-Pet Fragment Unlocks

| Level | Fragment | Content Type |
|-------|----------|--------------|
| Bond 1 | Origin Snippet | In-game selection screen |
| Bond 5 | Fragment I | Discovery story |
| Bond 10 | Fragment II | Formation lore |
| Bond 15 | Fragment III | Observed behaviors |
| Bond 20 | Fragment IV | Deep emotional lore |
| Bond 30 | Fragment V* | Extended lore (*Whisp, Luxe only) |
| Bond 50 | Secret | Hidden truth |
...
When writing additional lore fragments:

1. **Use found-document framing** — journals, reports, letters, transcripts
2. **Leave mysteries open** — don't over-explain
3. **Emotional truth over factual detail** — feelings matter more than mechanics
4. **Each pet has hidden depth** — surface personality masks something deeper
5. **Cozy, not dark** — melancholy is okay, tragedy is not
...
| Warm | Saccharine |
| Curious | Exposition-heavy |
| Earned emotion | Manipulative |

### Voice Examples

**Good:** *"It didn't answer. They never do. But something in its eyes suggested: longer than I want to remember."*

**Too dark:** *"The Munchlet had been abandoned, starving and alone, for months before anyone found it."*

**Too light:** *"Munchlet is super happy and loves everyone! Yay!"*
...
| Luxe ✨ | Unknown | Rare | Unknown | Refinement | Constructed identity |

### Origin Snippets (Selection Screen)

```
MUNCHLET: Found on a sunny windowsill, humming. Waiting for someone to share warmth with.
GRIB: Appeared in a shadow behind the cupboard, grinning. Not telling how.
PLOMPO: Discovered sleeping in a cloud that drifted too low. Went back to sleep.
...
CHOMPER: First spotted near the kitchen, following the smell of dinner.
WHISP: Drifted in through a crack in a dream. Sometimes forgets which world.
LUXE: Arrived already posing. Certain they deserve better.
```

### Likes/Hates (Selection Screen)

```
MUNCHLET: Loves sweet things. Hates being alone.
GRIB: Loves chaos. Hates boredom.
PLOMPO: Loves naps. Hates rushing.
FIZZ: Loves excitement. Hates waiting.
EMBER: Loves attention. Hates being ordinary.
CHOMPER: Loves food. Hates... just loves food.
WHISP: Loves quiet. Hates loud noises.
LUXE: Loves luxury. Hates anything ordinary.
```

---

*📜 End of Codex — Version 1.0*
